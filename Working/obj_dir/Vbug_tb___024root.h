...
class Vbug_tb___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ acq_ctrl_tb__DOT__rst;
    CData/*0:0*/ acq_ctrl_tb__DOT__clk;
    CData/*0:0*/ acq_ctrl_tb__DOT__varA;
    CData/*0:0*/ acq_ctrl_tb__DOT__varB;
    CData/*0:0*/ acq_ctrl_tb__DOT__varC;
    CData/*0:0*/ acq_ctrl_tb__DOT__varD;
