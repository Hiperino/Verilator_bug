...
VL_ATTR_COLD void Vbug_tb___024root___ctor_var_reset(Vbug_tb___024root* vlSelf) {
    ...
    // Body
    vlSelf->acq_ctrl_tb__DOT__rst = VL_RAND_RESET_I(1);
    vlSelf->acq_ctrl_tb__DOT__clk = VL_RAND_RESET_I(1);
    vlSelf->acq_ctrl_tb__DOT__varA = VL_RAND_RESET_I(1);
    vlSelf->acq_ctrl_tb__DOT__varB = VL_RAND_RESET_I(1);
    vlSelf->acq_ctrl_tb__DOT__varC = VL_RAND_RESET_I(1);
    vlSelf->acq_ctrl_tb__DOT__varD = VL_RAND_RESET_I(1);
