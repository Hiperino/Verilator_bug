...
VL_ATTR_COLD void Vbug_tb___024root__trace_init_sub__TOP__0(Vbug_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->pushNamePrefix("acq_ctrl_tb ");
    tracep->declBus(c+6,"CLOCK_HALF_PERIOD", false,-1, 31,0);
    tracep->declBus(c+7,"CLOCK_CYCLE", false,-1, 31,0);
    tracep->declBit(c+1,"rst", false,-1);
    tracep->declBit(c+2,"clk", false,-1);
    tracep->declBit(c+3,"varA", false,-1);
    tracep->declBit(c+4,"varB", false,-1);
    tracep->declBit(c+8,"varC", false,-1);
...
VL_ATTR_COLD void Vbug_tb___024root__trace_full_sub_0(Vbug_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullBit(oldp+1,(vlSelf->acq_ctrl_tb__DOT__rst));
    bufp->fullBit(oldp+2,(vlSelf->acq_ctrl_tb__DOT__clk));
    bufp->fullBit(oldp+3,(vlSelf->acq_ctrl_tb__DOT__varA));
    bufp->fullBit(oldp+4,(vlSelf->acq_ctrl_tb__DOT__varB));
    bufp->fullBit(oldp+5,(vlSelf->acq_ctrl_tb__DOT__varD));
    bufp->fullIData(oldp+6,(5U),32);
    bufp->fullIData(oldp+7,(0xaU),32);
    bufp->fullBit(oldp+8,(vlSelf->acq_ctrl_tb__DOT__varC));
}
