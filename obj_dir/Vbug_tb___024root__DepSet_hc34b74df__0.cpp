...
VL_INLINE_OPT VlCoroutine Vbug_tb___024root___eval_initial__TOP__0(Vbug_tb___024root* vlSelf) {
    ...
    // Body
    while (1U) {
        vlSelf->bug_tb__DOT__rst = 1U;
        vlSelf->bug_tb__DOT__clk = 0U;
        vlSelf->bug_tb__DOT__varA = 0U;
        vlSelf->bug_tb__DOT__varC = 0U;
        vlSelf->bug_tb__DOT__varB = 0U;
        vlSelf->bug_tb__DOT__varD = 0U;
        co_await vlSelf->__VdlySched.delay(0xaU, "bug_tb.sv", 29);
        vlSelf->bug_tb__DOT__rst = 0U;
        vlSelf->bug_tb__DOT__varB = 1U;
        VL_WRITEF("rst: %1#, varB: %1#\n",1,vlSelf->bug_tb__DOT__rst,
                  1,(IData)(vlSelf->bug_tb__DOT__varB));
        co_await vlSelf->__VdlySched.delay(0xaU, "bug_tb.sv", 35);
        VL_FINISH_MT("bug_tb.sv", 37, "");
    }
...
VL_INLINE_OPT VlCoroutine Vbug_tb___024root___eval_initial__TOP__1(Vbug_tb___024root* vlSelf) {
    ...
    // Body
    while (1U) {
        co_await vlSelf->__VdlySched.delay(5U, "bug_tb.sv", 18);
        vlSelf->bug_tb__DOT__clk = (1U & (~ (IData)(vlSelf->bug_tb__DOT__clk)));
    }
}
...
#endif
                    VL_FATAL_MT("bug_tb.sv", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("bug_tb.sv", 1, "", "NBA region did not converge.");
            }
